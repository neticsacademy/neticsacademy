      ...
      <div className="eligibility-section">
        ...
        <div className="eligibility-container">
          ...
          <div className="eligibility-card">
            ...
            <h5>Eligibility:</h5>
            <ul>
              <li>Postgraduate degree in the relevant subject with minimum 50% marks.</li>
              <li>B.Ed. degree in the concerned subject from a recognized university.</li>
              <li>Pass in State Eligibility Test (SET) or equivalent.</li>
            </ul>
            <h5>Exam Rules:</h5>
            <ul>
              <li>Written examination with objective and descriptive sections.</li>
              <li>Includes subject knowledge, teaching aptitude, and general awareness.</li>
              <li>Followed by interview and document verification.</li>
            </ul>
          </div>
          ...
          <div className="eligibility-card">
            ...
            <h5>Eligibility:</h5>
            <ul>
              <li>Minimum qualification: 10+2 or equivalent with at least 50% marks.</li>
              <li>Relaxation in marks for reserved categories as per government norms.</li>
              <li>Minimum age: 17 years.</li>
            </ul>
            <h5>Exam Rules:</h5>
            <ul>
              <li>Entrance test may include sections on language ability, teaching aptitude, and reasoning.</li>
              <li>Some institutions conduct interviews or counseling for admission.</li>
              <li>Course duration typically 2 years with internal and external assessments.</li>
            </ul>
          </div>
        </div>
      </div>
